defmodule NervesSystemJetsonOrinNano.MixProject do
  use Mix.Project

  @github_organization "isaiahdw"
  @app :nerves_system_jetson_orin_nano
  ...
  defp nerves_package do
    [
      ...
      #
      # The Orin Nano's cores are Cortex-A78AE; cortex-a78 tuning is the
      # conservative spelling both GCC and LLVM accept.
      env: [
        {"TARGET_ARCH", "aarch64"},
        {"TARGET_CPU", "cortex_a78"},
        {"TARGET_OS", "linux"},
        {"TARGET_ABI", "gnu"},
        {"TARGET_GCC_FLAGS",
         "-mabi=lp64 -fstack-protector-strong -mcpu=cortex-a78 -fPIE -pie -Wl,-z,now -Wl,-z,relro"}
      ],
  ...
  defp description do
    "Nerves system for the NVIDIA Jetson Orin Nano 4GB module (p3767-0004) " <>
      "on the Waveshare JETSON-ORIN-IO-BASE carrier (UEFI boot, Jetson Linux r39.2 kernel)"
  end
