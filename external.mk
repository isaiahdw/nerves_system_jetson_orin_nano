...
# patch or config fragment quietly is not in the image.
#
...
# The kernel: linux/*.patch (applied at extract) and linux/nerves.config
# (applied at configure, whose stamp also does not track content).
